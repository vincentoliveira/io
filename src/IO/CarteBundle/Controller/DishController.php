...
use IO\CarteBundle\Form\DishType;
...
class DishController extends Controller
{
     ...
     * 
     * @Template("IOCarteBundle:Dish:new.html.twig")
     ...
     * 
     * @Template("IOCarteBundle:Dish:edit.html.twig")
     * @ParamConverter("dish", class="IOCarteBundle:Dish", options={"id" = "id"})
     * @Secure(roles="ROLE_RESTAURATEUR")
     * 
