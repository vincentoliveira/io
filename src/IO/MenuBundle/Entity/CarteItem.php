...
class CarteItem
{
     ...
     * @var string
     *
     * @ORM\OneToOne(targetEntity="IO\MenuBundle\Entity\Media", cascade={"persist"})
     ...
     * @return CarteItem
     */
    public function setRestaurant(\IO\MenuBundle\Entity\Restaurant $restaurant)
    {
     ...
     * @return CarteItem
     */
    public function setMedia(\IO\MenuBundle\Entity\Media $media = null)
    {
        $this->media = $media;
     ...
     * Get media
     *
     * @return \IO\MenuBundle\Entity\Media 
     */
